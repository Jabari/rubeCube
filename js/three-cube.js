...
function init() {
  var axis, axises, left, camera, clicking, controls, cshift, cube, cubes, curor, curpos, currentFrame, d, de2ra, defdir, directionalLight, findcoord, getAxisFromRot, getDirFromLocRot, getDirFromRot, getDirFromTopRot, getNewAxis, globqty, right, lastFrame, lastdir, lerp, makecube, mouse, mousepos, movcam, moving, right, origincam, position, ra2de, front, render, renderer, rotWorldMatrix, rotate, rotateAroundWorldAxis, scene, shiftcube, target, targetcam, time, time2, timeDelta, bottom, top;
  ...
  function invertColor() {
    ...
    console.log('invert: ' + invertedColor);
  ...
  function newColors() {
    ...
    left = randomColor() | invertColor(); 
    right = top & back & bottom; 
  }
