...
.controller('colorGen', function($scope) {
	...
	var randomRGB = function(){
		var value = 255;
		var color = Math.floor(Math.random() * value);
		return color;
	}
	var red, green, blue;
	red = randomRGB();
	...
	var randomRGB = "rgb(" + red + ", " + green + ", " + blue +")";
 	...
 	bottom = document.querySelector('.bottom-face');
 	back = document.querySelector('.back-face');
 	left = document.querySelector('.left-face');
 	right = document.querySelector('.right-face');
	var int = 1;
